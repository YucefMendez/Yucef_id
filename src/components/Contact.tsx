...
export default function Contact() {
  return (
    <section id="contact" className="py-24 relative">
      ...
      {/* Background glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[300px] rounded-full bg-accent/5 blur-[100px] pointer-events-none" />

      <div className="max-w-6xl mx-auto section-padding relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          <p className="font-mono text-sm text-accent mb-3 tracking-widest uppercase">05 / Contact</p>
          ...
          <a
            href={`mailto:${siteConfig.email}`}
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-accent text-[#0a0f1e] font-semibold text-base hover:bg-accent-dark hover:scale-105 transition-all duration-200 shadow-lg shadow-accent/25 mb-10"
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <rect x="2" y="4" width="20" height="16" rx="2" />
              <path d="m22 7-10 7L2 7" />
